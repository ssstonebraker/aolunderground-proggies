...
anyway. [This text was written in January 2000 for the 5.0 version
of the API Spy. It still sort of applies.]
...
2. Send me the code add-in in the email and if it checks out ok, I'll add 
it to the list (a code add-in wont check out if the code it generates 
doesn't work or if the information isn't filled out right).
...
* Apply Code - Lets you manipulate windows with the API Spy.
