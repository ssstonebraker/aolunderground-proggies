...
End Sub
Function ChatClear(Txt As String)
'Ex: Call ChatClear("")
...
'Ex: Call Gotourl("http://www.devi1.com/flyman")
AIMwindow& = FindWindow("_Oscar_BuddyListWin", vbNullString)
...
'Ex: Call MassIM(List1,"I Am Usin Flyman2k Bas")
If ListList.ListCount = 0 Then
Do: DoEvents: Loop
End If
ListList.Enabled = False
I = ListList.ListCount - 1
ListList.ListIndex = 0
For X = 0 To I
ListList.ListIndex = X
Call SendIM(ListList.text, message)
timeout (0.8)
Next X
ListList.Enabled = True
End Function
Function SendIM(SN As String, message As String)
'Ex: Call SendIM("Fast Flyman","Im Usin Your Bas")
...
'Ex: Call Chat_Link("http://www.devi1.com/flyman","Flyman2k")
SendChat "<a href=""" + Link + """>" + message + ""
End Function
Function IM_Link(who As String, Link As String, message As String)
'Ex: Call IM_Link("Fast Flyman","http://www.devi1.com/flyman",Fly2k")
...
'Ex: C:Windows\Desktop\MyDocuments\Wav.wav
...
End Sub
Sub IM_Stamp_On()
'I found this as well as the off
'Ex: Call IM_Stamp_On
    Dim IMwin As Long
...
'Example:  In a forms mousedown event put this code
'Call FormMove(me)
Dim dragme&
ReleaseCapture
dragme& = SendMessage(frm.hwnd, &H112, &HF012, 0)
End Sub
...
'Ex: Call Bot_Attention("I'm Usin Flyman2k Bas!")
Call SendChat("<B>A T T E N T I O N</B>")
Call SendChat(text$)
Call SendChat("<B>A T T E N T I O N</B>")
End Sub
Public Sub AddChatList(List As ListBox, AddUser As Boolean)
'Ex: Call Add_ChatToList(List1,"Person")
...
If Text1.text = "Fast Flyman" Then
MsgBox "Yes You Found Me", vbOKOnly, "Don't Bug me"
Else
MsgBox "Um.." + Text1.text + " Isn't me", vbOKOnly, "Thats A"
Poser! ""
End If
...
'who to lamerize
Call SendChat("·  lamerizer found " & Nam & "  ·")
Pause (2.6)
Dim X As Integer
Dim lcse As String
Dim letr As String
...
'Compatable For: Visual Basic5,Visual Basic 6 32bit

'AIM Version(s): 2.5-4.0

'My Site: FLYMAN 2000

'Url:http://www.flyman2000.com

'Relase Date: I don't remember,but I have had it for
'a while on my desktop for finnishing

'Api Spy Used: Pat Or Jk 4.0,Mav Spy 4.0.

'Can I Use a sub?: Yes but please give me credit.

'Why a AIM Bas? Well it was really an update and I
'felt sorry for FlyAim3.5 cause it was small.

'Subs: Count your self,j/k there is: 114subs

'Also look for my soon to be next bas(No AIM).
'Its going to have some useful things for your
'software.
End Sub

Sub Beep()
'Whats Beep? Just enter it in your form and hear a
'beep
'Ex: Call Beep
Beep
End Sub
Function ListCount(the As ListBox)
'Ex: Call Listcount(List1)
Dim List$
List$ = the.ListCount
List_Count = List$
End Function
Sub MoveMouse(X1 As Long, Y1 As Long)
'I found this somewere on the net.
...
End Sub
Sub ChatScroll(thetext As String)
'Ex: Call ChatScroll(Text1.text)
'or
'Ex: Call ChatScroll("HeH")
...
End Sub
Sub Special_Thanks()
'If your not here then its I don't know you well.
'Or I don't talk to you much.Don't ask y ur not here.
'I'd like to thank blackout he's a very cool person
'also illegal for bein so cool.Quirk who is like the
'best aim programer i've ever met.Imperial for bein
'a tad nuts.Those are 4 names I had to say,sorry if
...
End If
End Sub
Function theDate() As String
'Picked this up somewhere on the net
fulldate$ = Format$(Now, "dddd, mmmm dd, yyyy")
End Function
...
'This Was Made By Trend!!!
'Ex: Call Ad_Change("Flyman")
