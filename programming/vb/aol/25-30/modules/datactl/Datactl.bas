'
' Visual Basic Data Access constants
'
...
Global Const DB_UPDATABLE = &H1
Global Const DB_BOOKMARKABLE = &H2
Global Const DB_ROLLBACKABLE = &H4
Global Const DB_RESTARTABLE = &H8
Global Const DB_NOINSERTS = &H10

' SetDataAccessOption
Global Const DB_INITPATH = 1
Global Const DB_COMMITONLIMIT = 2
...
Global Const BUTTON_HIGHLIGHT = &H80000014      ' Highlight on buttons.
...
'VerbFlag Bit Masks
Global Const VF_GRAYED = &H1
Global Const VF_DISABLED = &H2
Global Const VF_CHECKED = &H8
Global Const VF_SEPARATOR = &H800
