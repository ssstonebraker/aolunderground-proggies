...
'
'Dos32.bas by Dos
'Edited by GuN for guns lil mchat example
'email gun@vbhq.com for help
'http://www.vbhq.com
...
Public Sub MailForward(SendTo As String, Message As String, DeleteFwd As Boolean)
    ...
    If DeleteFwd = True Then
        ...
        Call SendMEssageByString(EditSubject&, WM_SETTEXT, 0, "VoiD - " & TempSubject$)
        DoEvents
    End If
...
Public Sub MemberRoom(Room As String)
    Call aol40_Keyword("aol://2719:61-2-" & Room$)
End Sub
...
Public Sub aol40_Keyword(KW As String)
    Dim AOL As Long, tool As Long, Toolbar As Long
...
Public Sub StayOnTop(FormName As Form)
    Call SetWindowPos(FormName.hWnd, HWND_TOPMOST, 0&, 0&, 0&, 0&, Flags)
End Sub
Function XAOL4_GetCurrentRoomName()
XAOL4_GetCurrentRoomName = GetCaption(FindRoom)
End Function
