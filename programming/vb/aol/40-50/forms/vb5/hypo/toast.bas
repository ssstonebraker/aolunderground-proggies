...
Dim ErrorNumber
For ErrorNumber = 0 To 5000
    Printer.Print Error(ErrorNumber)
Next ErrorNumber
End Sub
Sub HideToolbar()

a% = FindChildByClass(FindAOL, "AOL Toolbar")
HideWindow a%
End Sub
Sub ShowToolbar()
s = FindChildByClass(FindAOL, "AOL Toolbar")
a = ShowWindow(s, 5)
End Sub
Sub ChangeSignoff(Newcaption As String)
ao1% = FindWindow("AOL Frame25", vbNullString)
Found = ao1%
 chng% = FindChildByClass(ao1, "AOL Child")
Call settext(chng%, Newcaption)
End Sub
