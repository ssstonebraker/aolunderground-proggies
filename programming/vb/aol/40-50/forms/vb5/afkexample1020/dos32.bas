...
End Sub
Public Sub AOLPreferences()
Dim aol As Long, AOLToolbar As Long, AOLIcon As Long, toolbar As Long
Dim smod As Long, WinVis As Long, CurPos As POINTAPI
aol& = FindWindow("AOL Frame25", vbNullString)
AOLToolbar& = FindWindowEx(aol&, 0&, "AOL Toolbar", vbNullString)
toolbar& = FindWindowEx(AOLToolbar&, 0&, "_AOL_Toolbar", vbNullString)
AOLIcon& = FindWindowEx(toolbar&, AOLIcon&, "_AOL_Icon", vbNullString)
AOLIcon& = FindWindowEx(toolbar&, AOLIcon&, "_AOL_Icon", vbNullString)
AOLIcon& = FindWindowEx(toolbar&, AOLIcon&, "_AOL_Icon", vbNullString)
AOLIcon& = FindWindowEx(toolbar&, AOLIcon&, "_AOL_Icon", vbNullString)
AOLIcon& = FindWindowEx(toolbar&, AOLIcon&, "_AOL_Icon", vbNullString)
...
Public Function LAG() As String
LAG = "</HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML>"
LAG = LAG + "</HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML></HTML><HTML>"
End Function
