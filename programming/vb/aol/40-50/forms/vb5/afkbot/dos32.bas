...
End Sub
Public Sub Send_Chat(Chat As String)
    Dim Room As Long, AORich As Long, AORich2 As Long
    Room& = FindRoom&
    AORich& = FindWindowEx(Room, 0&, "RICHCNTL", vbNullString)
    AORich2& = FindWindowEx(Room, AORich, "RICHCNTL", vbNullString)
...
Public Sub IMsOff2()
    Call InstantMessage("$IM_OFF", "ReeFeR Toolz Says , FUCKIN TURN 'EM OFF!!! ")
End Sub

Public Sub IMsOn2()
    Call InstantMessage("$IM_ON", "ReeFeR Toolz Says , FUCKIN TURN 'EM ON!!! ")
End Sub
...
Public Sub Keyword2(KW As String)
    Dim AOL As Long, tool As Long, Toolbar As Long
