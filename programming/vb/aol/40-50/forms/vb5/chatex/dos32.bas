...
' The following was added by Ghost (krsGhost@juno.com)
' Sub Click - Clicks Icons ( use Sub Button for buttons )
' Function GetDrive - Gets the HD drive letter
' Function GetWindowDir - Gets Windows directory
...
Function GetDrive()
Dim WinDir, Drive As String
WinDir = GetWindowDir()
Drive = Left$(WinDir, InStr(WinDir, ":"))
...
Public Sub Click(TheIcon As Long)
    Call SendMessage(TheIcon&, WM_LBUTTONDOWN, 0&, 0&)
    Call SendMessage(TheIcon&, WM_LBUTTONUP, 0&, 0&)
End Sub
