...
Next X
End Function
Function WindowSPYTextBoxs(WinHdl As TextBox, WinClass As TextBox, WinTxT As TextBox, WinStyle As TextBox, WinIDNum As TextBox, WinPHandle As TextBox, WinPText As TextBox, WinPClass As TextBox, WinModule As TextBox)
...
Click (Button&)
End Sub
Function FindChildByTitle(Parent As String, child As String)
