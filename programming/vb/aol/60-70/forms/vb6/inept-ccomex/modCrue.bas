...
Public Sub ScrollMacro(ByVal TheMacro As String, ByVal PauseScroll As Boolean)
    ...
    If PauseScroll = True Then
        Call chatsendMulti(TheMacro2, True, 2)
    Else
        Call chatsendMulti(TheMacro2, False)
    End If
End Sub
...
End Sub
Public Sub chatsendAIM(ByVal TheMessage As String)
    'this sub sends chat to AIM's chat room
    'Example of use:
    '   Call chatsendAIM("http://come.to/cruelair")
    Dim TheRoom As Long
    TheRoom& = FindAIMChat&
...
Public Sub VPKeyword(ByVal strKeyword As String)
    ...
    Call SendMessageLong(Edit&, WM_CHAR, VK_RETURN, 0&)
End Sub
Public Sub VPchatsend(ByVal Chat As String)
    'this sub sends chat to Virtual Places
    'Example of use:
    '   Call VPchatsend("http://come.to/cruelair")
...
Public Sub chatsend(ByVal ChatString As String)
    'this sub will send text to AOL's chat room
    'Example of use:
    '   Call chatsend("http://come.to/cruelair")
...
Public Sub chatsendMulti(ByVal TheStrings As Variant, ByVal PauseBetween As Boolean, Optional ByVal PauseDuration As Long)
    ...
    'each chatsend, but using this also means the program itself has to do
    'much less work.
    'Example of use:
    ...
    '    Call chatsendMulti(ChatStrings, False)
    '    Call chatsendMulti(chatStrings, True, 2)
    Dim ChatRoom As Long, SendIcon As Long, Rich As Long
...
Public Sub pause(ByVal TheDuration As Long)
