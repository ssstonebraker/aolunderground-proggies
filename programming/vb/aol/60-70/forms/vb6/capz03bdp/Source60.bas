...
Public Function Pause2(Time As Long)
...
GetText$ = abc$
End Function
Public Sub ChatSend(SendString As String, Optional SendAfterPlaceBack As Boolean = False)
If FindChatRoom& = 0& Then Exit Sub
...
Call SendMessageByString(RichText2&, WM_SETTEXT, 0&, "")
